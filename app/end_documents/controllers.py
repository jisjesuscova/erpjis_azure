...
def document(rut, id):
   ...
   data = [exit_company_date, full_name, old_employee.rut, job_position.job_position, entrance_company, causal.causal, indemnity_years_service, substitute_compensation, voluntary_indemnity, end_document.fertility_proportional_days, fertility_proportional, total]
