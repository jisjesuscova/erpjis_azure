...
class Pdf:
    ...
    def create_pdf(file_name, data, multiple_data = ''):
        ...
        rendered = render_template(template_path, data = data, root = 'https://jiserp.com/', multiple_data = multiple_data)
    ...
    def create_vacation_pdf(file_name, data, multiple_data = '', total_data = ''):
        ...
        rendered = render_template(template_path, data = data, root = 'https://jiserp.com/', multiple_data = multiple_data, total_data = total_data)
